...
// import { ProductCT } from '../../context/ProductContext';
// import { IProduct, Review } from '../../interfaces/IProduct';

// const ReviewDetail: React.FC = () => {
//     const { reviewId } = useParams<{ reviewId: string | number }>();
//     const { products } = useContext(ProductCT)!;

//     // Find the review by its ID across all products
//     let foundReview: Review | null = null;
//     products.forEach((product: IProduct) => {
//         const review = product.reviews.find(r => r.id === reviewId || r.id === Number(reviewId));
//         if (review) {
//             foundReview = review;
//         }
//     });
...
//     if (!foundReview) {
//         return <p className="text-red-500">Đánh giá không tồn tại</p>;
//     }

//     return (
//         <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
//             <h2 className="text-3xl font-bold mb-4">Chi tiết bình luận</h2>
//             <p className="font-semibold">Người dùng: {foundReview.user.name}</p>
//             <p className="text-yellow-500">Đánh giá: {foundReview.rating} sao</p>
//             <p className="text-gray-700">Bình luận: {foundReview.comment}</p>
//             <p className="text-gray-500 text-sm">Ngày đăng: {foundReview.createdAt}</p>

//             <Link to={`/product/${foundReview.user.id}`} className="text-blue-500 hover:underline">Quay lại chi tiết sản phẩm</Link>
//         </div>
//     );
// };
